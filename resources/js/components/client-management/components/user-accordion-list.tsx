...
const UserAccordionList: React.FC<Props> = ({
    ...
    const mainText = lighten(theme.palette.text.primary, 0.3); 
    ...
    return usersList.length === 0 ? (
        <Box
            sx={{
                ...
                minHeight: { xs: 75, sm: 85, md: 90 },
            }}
        >
            <Typography sx={{ color: neutralText, fontWeight: 500, fontSize: { xs: '1rem', sm: '1.1rem', md: '1.2rem' }, textAlign: 'center' }}>
                {searchValue
                    ? 'No records found.'
                    : groupTab === 0
                    ? 'No registered users.'
                    ...
                    >
                        <img
                            ...
                            style={{
                                ...
                                borderRadius: '50%',
                                objectFit: 'cover',
                                marginRight: isMobile ? 14 : 18, // Increased margin for more space
                        ...
                        <Typography
                            variant="h6"
                            fontWeight="550" // Bold client name
                            component="span"
                            sx={{
