...
const RejectModal: React.FC<RejectModalProps> = ({
  ...
  const dividerColor = isDark
    ...
    : alpha(theme.palette.divider, 0.53);
          ...
          >
            ...
            <div style={{
              ...
              <div
                style={{
                  ...
                  marginRight: 12,
                  flexShrink: 0,
                  boxShadow: `0 2px 8px ${alpha(errorMain, 0.20)}`
                }}
              >
                <span style={{
                  fontSize: 25,
            ...
            <div style={{ display: 'flex', gap: 16, marginTop: 32 }}>
              ...
              <button
                ...
                style={{
                  flex: 1,
                  background: selectedReasons.length === 0 || processing
                    ? alpha(errorMain, 0.13)
                    : errorMain,
                  color: isDark ? theme.palette.common.white : mainText,
                  fontWeight: 700,
                  fontSize: 19,
                  border: 'none',
                  borderRadius: 99,
