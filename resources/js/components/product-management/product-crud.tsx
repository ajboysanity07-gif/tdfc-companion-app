...
const ProductCreateOrDelete: React.FC<Props> = ({
    ...
    // const mui = useTheme();
    // const accent = mui.palette.primary.main || '#3b82f6';
    ...
    const handleSave = useCallback(() => {
        onSave?.({
            ...
            service_fee: toNumber(serviceFee),
            lrf: toNumber(lrf),
            document_stamp: toNumber(docStamp),
            mort_plus_notarial: toNumber(mortNotarial),
            terms,
            typecodes: tags,
        });
    }, [
            ...
            <Stack spacing={1.5}>
                ...
                <Stack direction="row" spacing={1.5} alignItems="center">
                    <TextField
                        ...
                        label="Rate (P.A.)"
                        value={rate}
                        onChange={(e) => setRate(sanitizeNumber(e.target.value))}
                ...
                <Stack direction="row" spacing={1.5} alignItems="center">
                    <TextField
                        ...
                        label="Max Term (days)"
                        value={maxTerm}
                        onChange={(e) => setMaxTerm(sanitizeNumber(e.target.value))}
                ...
                <Typography variant="body2" sx={{ color: '#4aa3d7', mt: -0.5, alignItems: 'center' }}>
                            ...
                            >
                                <Stack direction="row" spacing={1.5} alignItems="center">
                                    <TextField
                                        ...
                                        value={maxAmort}
                                        onChange={(e) => setMaxAmort(sanitizeNumber(e.target.value))}
                            ...
                            >
                                <Stack direction="row" spacing={1.5} alignItems="center">
                                    <TextField
                                        ...
                                        onChange={(e) => setMaxAmortFormula(e.target.value)}
                                        onBlur={(e) => setMaxAmortFormula(e.target.value.trim())}
                                        placeholder="e.g. basic, 2 * basic, (basic * 5) / 0.5"
                                        helperText='Use "basic" as the member basic salary. Allowed: numbers, + - * / ( ).'
                                    />
                                </Stack>
                            </motion.div>
                        )}
                ...
                <TextField fullWidth multiline minRows={4} value={terms} onChange={(e) => setTerms(e.target.value)} />
            </Stack>
